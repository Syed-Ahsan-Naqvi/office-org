            ...
            <div className=''>
                ...
                <div className='bg-black h-[100vh]'>
                    <h1 data-aos="fade-up" data-aos-easing="ease-out-cubic"
                        data-aos-duration="2000" className='text-center text-white pt-64 text-2xl font-bold '  > <span className='text-5xl text-yellow-600 font-bold'>ABOUT US </span> </h1>
                </div>
                            ...
                            <div className="text-center lg:w-2/3 w-full">
                                ...
                                <div data-aos="fade-up" data-aos-easing="ease-out-cubic"
                                    ...
                                    <button data-aos="flip-down" data-aos-easing="ease-out-cubic"
                                        data-aos-duration="1000" className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
                                    <button data-aos="flip-down" data-aos-easing="ease-out-cubic"
                                        data-aos-duration="1000" className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Button</button>
                                </div>
                            </div>
                        </div>
                    </div>
