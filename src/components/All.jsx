        ...
        <div className=' overscroll-y-none ' >
            ...
            <div className='h-[100vh] bg-black ' >
                ...
                <div className="   visible " >
                    <span className=' block md:hidden text-center text-yellow-600 pt-52 text-4xl  font-bold pl-2 pr-2 md:pl-0 md:pr-0 '  >LET'S JOIN</span>
                    ...
                    <span className=' hidden md:block text-center text-white pt-52 text-2xl font-bold pl-2 pr-2 md:pl-0 md:pr-0 '  > <span className='  text-2xl md:text-5xl   text-yellow-600 font-bold'>LET'S JOIN</span> The  New Universe Of Technology</span>
                    ...
                    <div className=' text-center mt-12  '>
                        ...
                        <button className=" relative text-black hover:text-stone-50 bg-white hover:bg-white  focus:ring-4 focus:ring-blue-300  rounded-lg text-xl px-5 py-2.5 mr-2 mb-2 dark:bg-white  dark:hover:bg-black focus:outline-none dark:focus:ring-blue-800 font-bold">Contact Us</button>
                    </div>
                    {/* <Particle /> */}
            ...
            <div className=' overflow-x: hidden; flex justify-center items-center align-middle ' >
                <section className="text-gray-600 body-font ">
                    <div className="   container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                        ...
                        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center r">
            ...
            <div className='' >
                ...
                {/*  */}
                <div data-aos="zoom-in" data-aos-easing="ease-out-cubic"
                    data-aos-duration="3000" className='pt-16' >  <div className="flex justify-center items-center text-5xl md:text-6xl " > <span className="    " ><hr className=" w-14 md:w-20  border-2 border-yellow-600 " /></span> Our Services <span className="" ><hr className="  w-14 md:w-20 border-2  border-yellow-600 " /></span></div>
                </div>
                        ...
                        <div className="flex flex-wrap mt-4 -m-4">
                            ...
                            <div data-aos="fade-up" data-aos-easing="ease-out-cubic"
                                ...
                                <div className="h-full overflow-x: hidden; bg-yellow-600 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                    ...
                                    <h1 className="title-font sm:text-2xl text-xl font-medium text-yellow-600 text-black mb-3">SEO</h1>
                                    <p className="leading-relaxed mb-3 text-white">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                            ...
                            <div data-aos="fade-left" data-aos-easing="ease-out-cubic"
                                ...
                                <div className="h-full overflow-x: hidden; bg-yellow-600 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                    ...
                                    <h1 className="title-font sm:text-2xl text-xl font-medium text-yellow-600 text-black mb-3 ">GRAPHIC DESIGNING</h1>
                                    <p className="leading-relaxed mb-3 text-white">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                    ...
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                                <div class="h-full flex items-center border-gray-200 bg-yellow-600 border p-4 rounded-lg relative">
                            ...
                            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                                <div class="h-full flex items-center border-gray-200 border bg-yellow-600 p-4 rounded-lg relative ">
