        ...
        <div>
            <footer class="text-center bg-black text-white">
              ...
              "
                                ...
                                <div class="md:mr-auto mb-6 relative ">
                                    <button type="submit" className="  relative focus:outline-none text-white  bg-yellow-600 hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-300  rounded-lg text-xl px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900 font-bold">
                                        Subscribe
                                    </button>
                                </div>
                            </div>
